...
dependencies {
  ...
  implementation("com.typesafe.akka:akka-actor_${Globals.scalaMajorVersion}:${Globals.akkaVersion}")
  implementation("com.typesafe.akka:akka-slf4j_${Globals.scalaMajorVersion}:${Globals.akkaVersion}")
  implementation("com.typesafe.akka:akka-stream_${Globals.scalaMajorVersion}:${Globals.akkaVersion}")
...
tasks {
  ...
  withType<ScalaDoc> {
    println("scaladoc task disabled in order to existing issue: https://github.com/gradle/gradle/issues/9855")
    enabled = false
  }
}
